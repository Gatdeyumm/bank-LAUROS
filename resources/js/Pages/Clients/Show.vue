    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex justify-between">
                <h2 class="text-xl font-semibold leading-tight text-gray-800">View Client</h2>
                <div class="flex">
                    <Link :href="'/clients/email/' + client.id" class="flex p-2 mr-2 border border-gray-300 rounded shadow">Send Email</Link>
                    <a as="button" :href="'/clients/pdf/' + client.id" target="_blank" class="flex p-2 border border-gray-300 rounded shadow">
        ...
        <div class="py-12">
            <div class="flex justify-between mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div class="bg-white p-4 rounded shadow w-[30%]">
                    <h4 class="mb-3 text-2xl ">Client Info</h4>
                    <hr>
                ...
                <div class="bg-white p-4 rounded shadow w-[68%]">
                    <h4 class="mb-3 text-2xl">Transaction Log</h4>
